package a.monitor.scan.ktbaseliabrary.utils.contentresolver
    ...
    private fun findAnnotationMethod(any: Any): MutableList<ContentResolverMethod> {
        ...
        while (clazz != null) {
            ...
            for (index in methods.indices) {
                ...
                val contentObserverUri: ContentObserverUri? = method.getAnnotation(
                    ContentObserverUri::class.java)
                val contentObserverUriForChild: ContentObserverUriForChild? = method.getAnnotation(
                    ContentObserverUriForChild::class.java)
