package a.monitor.scan.ktbaseliabrary.event

import a.monitor.scan.ktbaseliabrary.proxy.EventBusProxy
...
object DefaultEventBusManager : EventBusProxy {
    ...
    override fun setOnEventBusListener(onEventBusListener: EventBusProxy.OnEventBusListener) {
        DefaultEventBusManager.onEventBusListener = onEventBusListener
    }
